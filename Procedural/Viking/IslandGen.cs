...
public class IslandGen : MonoBehaviour
{
    ...
    private void FindTerraceCounts()
    {
        ...
        {
            int tPoints = Random.Range(minTerracePoints, maxTerracePoints+1);
            int leftPoints = Random.Range(0, tPoints+1);
            tPoints = tPoints - leftPoints;
            int rightPoints = Random.Range(0, tPoints + 1);

            terraceCount[i, 0] = leftPoints;
            terraceCount[i, 1] = rightPoints;
        }
    }
